# Marcus 量化选股小助手 (AInvest) v1.5.0

> 基于 Agent 架构的 AI 量化选股平台，多策略融合、市场立场判断、自动推送一体化

---

## 📌 项目简介

**AInvest** 是一套面向 A 股市场的 **AI 量化选股小助手**，采用模块化 Agent 架构设计，整合**放量上涨、多因子、AI 技术面、机构追踪**等 5 大选股策略，通过加权平均生成综合评分，并基于 5 维度市场分析输出**激进/保守/观望**三档操作立场，最终结果通过邮件自动推送。
...
[MIT License](LICENSE) — Copyright (c) 2024 AInvest
